...
public class PublicKeyLoaderService {
    ...
    public RSAPublicKey loadSigningKey() {
        RestTemplate restTemplate = new RestTemplateBuilder()
                .basicAuthentication(securityConfigProperties.getUser(),
                        securityConfigProperties.getPassword())
                .build();
        ResponseEntity<Map> forEntity =
                restTemplate.getForEntity(securityConfigProperties.getUrl() + "/api/publicKey", Map.class);
