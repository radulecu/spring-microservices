...
public class JwtPublicKeyController {
    ...
    public JwtPublicKeyController(JwtCertificate jwtCertificate, ObjectMapper objectMapper) {
    ...
    @RequestMapping(path = "/publicKey", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
